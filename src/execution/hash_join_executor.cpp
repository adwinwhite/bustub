...
bool HashJoinExecutor::Next(Tuple *tuple, RID *rid) {
  ...
  // if (inner_ite_table_[inner_tuple_] == outer_hash_table_.equal_range(right_key).second) {
    ...
    // inner_ite_table_.insert({new_right_key, outer_hash_table_.equal_range(right_key).first});
  // }
  ...
  // *tuple = ConcatenateTuple(*outer_tuple_ite, left_child_->GetOutputSchema(), inner_tuple_, right_child_->GetOutputSchema());
